...
from encoder.train_SLMIA_SR import train_SLMIA_SR
...
if __name__ == "__main__":
    ...
    parser.add_argument("--no_visdom", action="store_true", help= \
        "Disable visdom.")
    parser.add_argument("--max_steps", type=int, default=315000)
    args = parser.parse_args()

    # Run the training
    print_args(args, parser)
    # train(**vars(args))
    train_SLMIA_SR(**vars(args)) ## added code for SLMIA_SR
